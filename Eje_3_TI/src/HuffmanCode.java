...
public class HuffmanCode {
	...
	public String toString() {
		String str = "";
		str += "*** La probabilidad es:" + (probabilityIsGiven ? " " : " No ") + "Dada. "
				+ (probabilityIsGiven ? "No calculamos la probabilidad."
						: "La probabilidad se calculó utilizando la frecuencia de cada carácter en el String dado.")
				+ "\n";
		str += "String Original: \"" + originalString + "\"\n";
		str += "------------------------------------------------------------------------\n";
		str += "Simbolo\t\tFrecuencia\tProbabilidad\tCod Huffman\tcod ASCII\n";
		str += "------------------------------------------------------------------------\n";
		...
		str += "------------------------------------------------------------------------\n";
		str += "Eficiencia antes de la compresión: " + 100 * (Math.round((entropy / averageLengthBefore) * 100.0) / 100.0)
				+ "%\n";
		str += "Eficiencia después de la compresión: " + 100 * (Math.round((entropy / averageLengthAfter) * 100.0) / 100.0)
				+ "%\n";
		str += "------------------------------------------------------------------------\n";
		return str;
	}
