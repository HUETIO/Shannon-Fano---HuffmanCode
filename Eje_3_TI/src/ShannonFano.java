...
public class ShannonFano {
	...
	public String toString() {
		String str = "";
		str += "*** La probabilidad es:" + (probabilityIsGiven ? " " : " No ") + "Dado. "
				+ (probabilityIsGiven ? "No calculamos la Probabilidad."
						: "La probabilidad se calculó usando la frecuencia de cada carácter en el String dado.")
				+ "\n";
		str += "String Original: \"" + originalString + "\"\n";
		str += "------------------------------------------------------------------------\n";
		str += "Simbolo\t\tFrecuencia\tProbabilidad\tCod Shannon-F\tcod ASCII\n";
		str += "------------------------------------------------------------------------\n";
